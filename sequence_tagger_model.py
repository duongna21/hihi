...
class SequenceTagger(flair.nn.Model):
    ...
    def forward_labels_and_loss(self, sentences: Union[List[Sentence], Sentence],
        ...
        with torch.no_grad():
            ...
            tags, confidence = self._obtain_labels(feature, lengths)
            return tags, loss, confidence
    ...
    def predict(self, sentences: Union[List[Sentence], Sentence],
        ...
        with torch.no_grad():
            ...
            for i, batch in enumerate(batches):
                ...
                tags, _, confidence = self.forward_labels_and_loss(batch, sort=False)
                # print(_)
                # print(tags)
    ...
    def _obtain_labels(self, feature, lengths) -> List[List[Label]]:
        ...
        return tags, np.mean(confidences)
